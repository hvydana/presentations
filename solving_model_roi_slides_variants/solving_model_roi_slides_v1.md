...
style: |
  ...
  section.smallest pre { font-size: 0.68em; padding: 8px; margin: 0.25em 0; }
  ...
  section.tiny li { margin-bottom: 0.05em; }
  section.tiny h2 { font-size: 28px; margin-bottom: 0.3em; }
  section.tiny h3 { font-size: 1.05em; margin-top: 0.2em; margin-bottom: 0.2em; }
  ...
  .columns-3 { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1em; }
  .columns-wide { display: grid; grid-template-columns: auto 1fr; gap: 1em; }
...
## Crowdsourcing the Engineering Cycles to Close NVIDIA's Physical-AI Lead

**A PAVS proposal — turn a known target into an AMD-wide challenge**
...
On price-performance, we have a real, quantifiable advantage.
</div>
...
- The cheaper chip never gets a fair evaluation
...
The barrier is not the silicon. <strong>It is the ecosystem the customer has already built on top of NVIDIA.</strong>
</div>
...
<div class="highlight-box" style="text-align:center;">
A vertically integrated stack — <strong>TensorRT → Isaac ROS → cuRobo → Isaac Sim → Cosmos</strong> — where each layer consumes the one below and forecloses substitution.
</div>
...
<div style="display:flex; flex-direction:column; gap:6px; margin-top:4px;">
  <div style="background:#2a2a2a; border:1px solid #e05555; border-radius:6px; padding:8px 12px;"><strong style="color:#ff8a8a;">Small / mid-size robotics companies</strong><br><span style="font-size:0.88em; color:#ccc;">every engineering cycle is capex they cannot spare</span></div>
...
<div class="highlight-box" style="text-align:center;">
This is the <strong>soft-power gap</strong>: AMD is absent from every on-ramp above the compute layer — and it shows up directly in <strong>sales</strong>.
</div>
...
<div class="highlight-box" style="text-align:center;">
We need a model that <strong>kick-starts the work without asking one BU to fund the whole multi-year bill.</strong>
</div>
...
<div style="display:flex; flex-direction:column; gap:8px; margin-top:4px;">
  <div style="background:#333; border:1px solid #4caf50; border-radius:6px; padding:10px 12px;"><strong style="color:#4caf50;">Compute — we already have it</strong><br><span style="font-size:0.88em; color:#ccc;">AMD-wide clusters (ALOLA &amp; others); PAVS can broker access</span></div>
  <div style="background:#2a2a2a; border:1px solid #ff9800; border-radius:6px; padding:10px 12px;"><strong style="color:#ff9800;">Data — the real problem to solve</strong><br><span style="font-size:0.88em; color:#ccc;">the "1M open episodes vs trillions of tokens" gap in physical AI</span></div>
</div>
...
<div style="display:flex; align-items:stretch; justify-content:center; gap:8px; margin:10px 0;">
  <div style="background:#2a2a2a; border:1px solid #3498db; border-radius:6px; padding:10px 14px; text-align:center; width:150px;"><strong style="color:#3498db;">Pick a target model</strong><br><span style="font-size:0.82em; color:#ccc;">from the known NGC-parallel set</span></div>
  <div style="display:flex; align-items:center; color:#3498db; font-weight:bold;">&#8594;</div>
  <div style="background:#2a2a2a; border:1px solid #3498db; border-radius:6px; padding:10px 14px; text-align:center; width:150px;"><strong style="color:#3498db;">Train on AMD compute</strong><br><span style="font-size:0.82em; color:#ccc;">clusters PAVS brokers</span></div>
  <div style="display:flex; align-items:center; color:#3498db; font-weight:bold;">&#8594;</div>
  <div style="background:#2a2a2a; border:1px solid #3498db; border-radius:6px; padding:10px 14px; text-align:center; width:150px;"><strong style="color:#3498db;">Climb the leaderboard</strong><br><span style="font-size:0.82em; color:#ccc;">per-category, public webpage</span></div>
  <div style="display:flex; align-items:center; color:#4caf50; font-weight:bold;">&#8594;</div>
  <div style="background:#333; border:1px solid #4caf50; border-radius:6px; padding:10px 14px; text-align:center; width:160px; color:#fff;"><strong style="color:#4caf50;">PAVS validates &amp; publishes</strong><br><span style="font-size:0.82em; color:#ccc;">top 3–4 teams per category</span></div>
</div>
...
<div style="color:#3498db; font-weight:bold; font-size:1.1em;">ImageNet Challenge</div>
...
<div style="color:#9b59b6; font-weight:bold; font-size:1.1em;">Kaggle / Netflix Prize</div>
...
<div class="highlight-box" style="text-align:center;">
<em>"The right challenge stimulates the right engineer."</em> &nbsp; When the target is scored and public, <strong>crowdsourced effort closes gaps faster than any single funded roadmap.</strong>
</div>
...
<div class="highlight-box" style="text-align:center;">
The pieces exist. What's missing is <strong>organized, incentivized effort pointed at AMD silicon</strong> — exactly what a challenge creates.
</div>
...
<div style="background:#2a2a2a; border:1px solid #3498db; border-radius:8px; padding:12px; height:100%;">
<div style="color:#3498db; font-weight:bold; font-size:1.15em; margin-bottom:6px;">Organizer (PAVS)</div>
...
<div style="background:#2a2a2a; border:1px solid #ff9800; border-radius:8px; padding:12px; height:100%;">
...
<div class="highlight-box" style="text-align:center;">
One mechanism, three winners — the reason a crowdsourced challenge is <strong>self-sustaining</strong> rather than a one-off spend.
</div>
...
<div style="display:flex; flex-direction:column; align-items:center; gap:6px; margin-top:4px;">
  <div style="background:#2a2a2a; border:1px solid #4caf50; border-radius:6px; padding:8px 14px; width:92%; text-align:center;"><strong style="color:#4caf50;">The gateway</strong> — every physical-AI solution enters through PAVS</div>
  <div style="color:#3498db; font-size:1.2em;">&#8595;</div>
  <div style="background:#2a2a2a; border:1px solid #3498db; border-radius:6px; padding:8px 14px; width:92%; text-align:center;"><strong style="color:#3498db;">The bridge</strong> — connecting the islands of physical AI across AMD</div>
  <div style="color:#3498db; font-size:1.2em;">&#8595;</div>
  <div style="background:#333; border:1px solid #4caf50; border-radius:6px; padding:8px 14px; width:92%; text-align:center; color:#fff;"><strong style="color:#4caf50;">The lead player</strong> in a well-defined niche</div>
</div>
...
<div class="highlight-box" style="text-align:center;">
The organizing work is not overhead — it is how PAVS <strong>earns the relationships and the position</strong> to route physical AI to market on AMD.
</div>
...
## 11 · The Prize Is Worth the Effort
...
<div class="highlight-box" style="text-align:center;">
Every small/mid-size robotics company we <strong>onboard early</strong> — while their stack is still forming — is a customer NVIDIA's lock-in has not yet captured. The challenge is how we <strong>get there first, cheaply.</strong>
</div>
...
<div style="display:flex; justify-content:center; gap:16px; margin-top:20px; font-size:0.62em;">
  <div style="background:#2a2a2a; border:1px solid #4caf50; border-radius:8px; padding:14px 18px; width:230px;"><strong style="color:#4caf50;">Bless the format</strong><br>org-wide challenge + per-category leaderboards + public webpage</div>
  <div style="background:#2a2a2a; border:1px solid #3498db; border-radius:8px; padding:14px 18px; width:230px;"><strong style="color:#3498db;">Unlock the compute</strong><br>endorse PAVS brokering ALOLA &amp; AMD-wide clusters to participants</div>
  <div style="background:#2a2a2a; border:1px solid #ff9800; border-radius:8px; padding:14px 18px; width:230px;"><strong style="color:#ff9800;">Back the incentive</strong><br>let winning work count as an AMD contribution &amp; go to market via PAVS</div>
</div>

**Known target · available compute · crowdsourced cycles — close the gap without betting one BU's budget on a multi-year bill.**