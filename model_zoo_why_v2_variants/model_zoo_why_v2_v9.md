...
<div style="display:flex; align-items:center; justify-content:center; gap:8px; margin-top:12px;">
  <div style="background:#2a2a2a; border:1px solid #4caf50; border-radius:6px; padding:6px 10px; text-align:center;"><strong style="color:#4caf50;">PAI SDK</strong><br><span style="font-size:0.82em; color:#ccc;">consumes</span></div>
