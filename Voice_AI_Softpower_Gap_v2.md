...
<div style="margin-top:5px; font-size:0.82em; color:#ccc;">Shaded <strong style="color:#ff8a8a;">ASR · LLM · TTS</strong> consume GPU cycles — AMD's advantage <em>and</em> its gaps both live here.</div>
...
<div class="highlight-box" style="text-align:center;">
<span style="font-size:1.25em; font-weight:bold; color:#4aa3ff;">Three of five layers burn GPU cycles every second of every call </span>
</div>
...
<div class="highlight-box" style="text-align:center;">
<span style="font-size:1.25em; font-weight:bold; color:#4aa3ff;">The advantage is real — yet unrealized in the Market — <span style="color:#4caf50;">This is not a hardware problem.</span></span>
</div>
...
<div class="highlight-box" style="text-align:center;">
<span style="font-size:1.25em; font-weight:bold; color:#ffffff;">The pattern: <span style="color:#4aa3ff;">ship the default package, and the hardware choice disappears at the call site.</span> <span style="color:#4caf50;">AMD is present at none of them.</span></span>
</div>
