...
<div class="columns" style="grid-template-columns: 1.5fr 1fr; align-items:center;">
<div>

![w:620](./model_zoo/Nvidia-model-zoo.png)

<div style="font-size:0.82em; color:#888; text-align:center;">NGC Catalog — curated, prepackaged models (PeopleNet, Mistral-7B Int4, …)</div>
...
<div style="display:flex; align-items:center; justify-content:center; gap:8px; margin-top:12px;">
  <div style="background:#2a2a2a; border:1px solid #4caf50; border-radius:6px; padding:6px 10px; text-align:center;"><strong style="color:#4caf50;">PAI SDK</strong><br><span style="font-size:0.82em; color:#ccc;">generates</span></div>
  <div style="color:#3498db; font-weight:bold;">&#8594;</div>
  <div style="background:#2a2a2a; border:1px solid #3498db; border-radius:6px; padding:6px 10px; text-align:center;"><strong style="color:#3498db;">AMD Model Zoo</strong><br><span style="font-size:0.82em; color:#ccc;">hosts weights</span></div>
  <div style="color:#3498db; font-weight:bold;">&#8594;</div>
  <div style="background:#2a2a2a; border:1px solid #4caf50; border-radius:6px; padding:6px 10px; text-align:center;"><strong style="color:#4caf50;">AARTS</strong><br><span style="font-size:0.82em; color:#ccc;">consumes</span></div>
</div>
...
**AMD needs exactly this pairing:** a **zoo** that hosts optimized models + an **SDK / robotics stack** that consumes them off-the-shelf.
...
<div class="columns" style="grid-template-columns: 1fr 1.9fr; align-items:center;">
<div>
...
![w:740](./model_zoo/AMD_PAVS_MODEL_ZOO.png)

<div style="font-size:0.8em; color:#888; text-align:center;">AMD-PAVS-AI on Hugging Face — 49 models, per-task, ready to pull</div>

</div>
</div>

<div class="highlight-box" style="border-left-color:#4caf50; text-align:center;">
