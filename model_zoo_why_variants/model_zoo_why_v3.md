...
<div style="display:flex; align-items:center; justify-content:center; gap:5px; margin:4px 0 8px 0; font-size:0.82em; flex-wrap:wrap;">
  <span style="background:#2a2a2a; border:1px solid #9b59b6; border-radius:5px; padding:4px 8px; color:#b07cc6; font-weight:bold;">AIG PyTorch</span>
  <span style="color:#3498db; font-weight:bold;">&#8594;</span>
  <span style="background:#2a2a2a; border:1px solid #00bcd4; border-radius:5px; padding:4px 8px; color:#00bcd4; font-weight:bold;">ONNX · MIGraphX · Vitis-AI</span>
  <span style="color:#3498db; font-weight:bold;">&#8594;</span>
  <span style="background:#2a2a2a; border:1px solid #00bcd4; border-radius:5px; padding:4px 8px; color:#00bcd4; font-weight:bold;">Quantize · AWQ / INT4</span>
  <span style="color:#3498db; font-weight:bold;">&#8594;</span>
  <span style="background:#2a2a2a; border:1px solid #00bcd4; border-radius:5px; padding:4px 8px; color:#00bcd4; font-weight:bold;">NPU flow</span>
  <span style="color:#4caf50; font-weight:bold;">&#8594;</span>
  <span style="background:#333; border:1px solid #4caf50; border-radius:5px; padding:4px 8px; color:#4caf50; font-weight:bold;">Zoo stores each stage &#10003;</span>
</div>
...
![w:400](./model_zoo/AMD_PAVS_MODEL_ZOO.png)
