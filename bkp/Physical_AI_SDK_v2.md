...
# NMTS 3 · inference — the SDK does everything
...
<div style="border:2px solid #3498db; border-radius:6px; padding:7px; background:#202020; margin-top:8px;">
  <div style="text-align:center; font-weight:bold; color:#ffffff; margin-bottom:5px; font-size:0.9em;">Physical AI SDK</div>
  <div style="background:#3498db; color:#ffffff; text-align:center; font-weight:bold; border-radius:4px; padding:4px 0; margin-bottom:6px; font-size:0.82em;">Inference Engine · unified interface</div>
  <div style="display:flex; gap:6px;">
    <div style="flex:1; background:#2a2a2a; border:1px solid #666; border-radius:4px; padding:4px 2px; text-align:center; font-size:0.72em;"><strong style="color:#00bcd4;">YOLOv12</strong><br>detect</div>
    <div style="flex:1; background:#2a2a2a; border:1px solid #666; border-radius:4px; padding:4px 2px; text-align:center; font-size:0.72em;"><strong style="color:#00bcd4;">MobileNetV3</strong><br>classify</div>
    <div style="flex:1; background:#2a2a2a; border:1px solid #666; border-radius:4px; padding:4px 2px; text-align:center; font-size:0.72em;"><strong style="color:#00bcd4;">MobileSAM</strong><br>segment</div>
  </div>
  <div style="text-align:center; color:#aaaaaa; font-size:0.72em; margin-top:6px;">AMD GPU · AMD NPU · AMD CPU</div>
</div>
...
<div style="border:2px solid #3498db; border-radius:8px; padding:12px; background:#202020; width:340px;">
  <div style="text-align:center; font-weight:bold; color:#ffffff; margin-bottom:10px;">Physical AI SDK</div>
  <div style="background:#3498db; color:#ffffff; text-align:center; font-weight:bold; border-radius:5px; padding:8px 0; margin-bottom:12px;">Inference Engine · unified interface</div>
  <div style="display:flex; gap:8px; justify-content:space-between;">
    <div style="flex:1; background:#2a2a2a; border:1px solid #666; border-radius:5px; padding:8px 4px; text-align:center; font-size:0.8em;"><strong style="color:#00bcd4;">YOLOv12</strong><br>detect</div>
    <div style="flex:1; background:#2a2a2a; border:1px solid #666; border-radius:5px; padding:8px 4px; text-align:center; font-size:0.8em;"><strong style="color:#00bcd4;">MobileNetV3</strong><br>classify</div>
    <div style="flex:1; background:#2a2a2a; border:1px solid #666; border-radius:5px; padding:8px 4px; text-align:center; font-size:0.8em;"><strong style="color:#00bcd4;">MobileSAM</strong><br>segment</div>
  </div>
  <div style="text-align:center; color:#aaaaaa; font-size:0.8em; margin-top:12px;">AMD GPU · AMD NPU · AMD CPU</div>
</div>

</div>
<div>

- **ROCm-optimized models** sit as interchangeable **sub-blocks**.
